...
<body class="min-h-screen bg-gradient-to-br from-slate-50 to-orange-50 flex items-center justify-center p-4">
    <div class="text-center max-w-md">
        <!-- Icon -->
        <div class="mb-6">
            <div class="inline-flex items-center justify-center w-24 h-24 rounded-full bg-orange-100 text-orange-600 mb-4">
                <i class="bx bx-error text-5xl"></i>
            </div>
        </div>
        
        <!-- Error Code -->
        <h1 class="text-7xl font-bold text-gray-800 mb-2">500</h1>
